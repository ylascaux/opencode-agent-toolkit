...
'''
    ...
    def test_legacy_task_keeps_scoped_hardening_but_native_ci_never_starts_dind(self):
        ...
        self.assertNotIn("bash scripts/task-dind", workflow)
        self.assertNotIn("apparmor_parser", workflow)
        self.assertNotIn("/workspace/.dind-smoke", workflow)
        self.assertIn("native-v2:", workflow)
