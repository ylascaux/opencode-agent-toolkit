...
class ModelProfileTests(unittest.TestCase):
    ...
    def test_codex_profile_uses_openai_gpt_5_3_codex(self):
        values = PROFILE["load_profile"]("codex")
        self.assertEqual(values["MODEL_PROFILE"], "codex")
        self.assertEqual(values["MODEL_LOW"], "openai/gpt-5.3-codex")
        self.assertEqual(values["MODEL_MEDIUM"], "openai/gpt-5.3-codex")
        self.assertEqual(values["MODEL_HIGH"], "openai/gpt-5.3-codex")
