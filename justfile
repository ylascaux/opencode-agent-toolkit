...
run *args:
    ./scripts/opencode-agents {{args}}

# Force OpenCode V1 stable for this invocation.
v1 *args:
    OPENCODE_MAJOR=1 ./scripts/opencode-agents {{args}}

# Force OpenCode 2 beta for this invocation.
v2 *args:
    OPENCODE_MAJOR=2 ./scripts/opencode-agents {{args}}

# Generate the normalized project architecture inventory.
scan *args:
    ./scripts/scan-projects {{args}} > architecture-inventory.json
